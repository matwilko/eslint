...
const { mapValues } = require("./utils/object");
...
/* eslint sort-keys: "off" -- More readable for long list */

const ruleLoaderDescriptors = mapValues(ruleLoaders, loader => ({ get: loader, enumerable: true }));

/*
 * Some extra methods/props for backwards compat with LazyLoadingRuleMap, but could consider removing.
 * These properties/methods won't be enumerable, so won't show up in Object.keys/Object.entries etc.
 */

/* eslint-disable object-shorthand -- makes property descriptors much harder to read */

ruleLoaderDescriptors.get = {
    value: function(key) {
        return this[key];
    }
};

ruleLoaderDescriptors.has = {
    value: function(key) {
        return key in this;
    }
};

const keys = Object.freeze(Object.keys(ruleLoaders).sort());

ruleLoaderDescriptors.size = {
    value: keys.length
};

ruleLoaderDescriptors.keys = {
    value: Array.prototype.values.bind(keys)
};

ruleLoaderDescriptors.values = {
    value: function *() {
...
ruleLoaderDescriptors[Symbol.iterator] = ruleLoaderDescriptors.entries;

ruleLoaderDescriptors.forEach = {
    value: function(callbackFn, thisArg) {
        for (const [ruleName, rule] of this) {
            Function.prototype.call.call(callbackFn, thisArg, rule, ruleName, this);
        }
    }
};

/* eslint-enable object-shorthand -- makes property descriptors much harder to read */

module.exports = Object.freeze(Object.create(null, ruleLoaderDescriptors));
