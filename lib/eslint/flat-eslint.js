...
const { supportedEcmaVersions, latestSupportedEcmaVersion, isSupportedEcmaVersion } = require("../shared/ecma-versions");
...
class FlatESLint {
    ...
    /**
     * The set of ECMAScript versions supported by ESLint.
     * @type {Array<string>}
     */
    static get supportedEcmaVersions() {
        return supportedEcmaVersions;
    }
     ...
     * @type {string}
     */
    static get latestSupportedEcmaVersion() {
        return latestSupportedEcmaVersion;
    }

    /**
     * Tests whether the given ECMAScript version is supported by ESLint.
     * @param {string | number} ecmaVersion The ECMAScript version to test.
     * The version can be a string of the form "es{specVersion}" (e.g. "es7"),
     * "es{specYear}" (e.g. "es2018"), or a number which can be either
     * a spec version or a year.
     * @returns {boolean} `true` if the ECMAScript version is valid and supported.
     */
    static hasSupportForEcmaVersion(ecmaVersion) {
        return isSupportedEcmaVersion(ecmaVersion);
    }
